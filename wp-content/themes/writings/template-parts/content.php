...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php
			...
			if ( is_singular() && has_post_thumbnail( get_queried_object_id() ) ) :
				if ( writings(  ) == 'display' && writings( 'position_single_featured_image' ) != 'below' ) {
					echo '<div class="single-featured-image-header">' . get_the_post_thumbnail( get_queried_object_id(),  ) . '</div>';
				}
			endif;
		?>
